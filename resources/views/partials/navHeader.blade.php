                ...
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <p><a class="nav-link-ubicacion" href="{{ route('app.home') }}">Panel de Control</a> /
                                Asistencia / Asistencia Estudiante</p>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <p><a class="nav-link-ubicacion" href="{{ route('app.home') }}">Panel de Control</a> / Docentes</p>
                        </div>
                    ...
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <h2 class="h1"> <i class="icon">
                                ...
                                </i>Personal Administrativo</h2>
                            <p><a class="nav-link-ubicacion" href="{{ route('app.home') }}">Panel de Control</a> / Personal Administrativo</p>
                        </div>
