<aside class="sidebar sidebar-default navs-pill-all mb-3">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        ...
        <a href="{{ route('home') }}" class="navbar-brand d-none d-md-block">
            ...
            <img class="logo-title" src="{{ asset('assets/images/logo_nombre.webp') }}" width="80px"
                alt="Nombre Colegio Mundo Feliz">
        </a>
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                <li class="nav-item dropdown">
                    <div class="raw d-flex">
                        ...
                        <div class="caption py-1 d-md-block">
                ...
                @if (auth()->user()->hasPermission('VER MATRICULA'))
                    <!-- Matrícula -->
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('dashboard/matriculas*') ||
                        request()->is('dashboard/matricula-aula*') ||
                        Route::is('app.showaula*')
                            ? 'active'
                            : '' }}"
                            data-bs-toggle="collapse" href="#matricula" role="button" aria-expanded="false"
                            aria-controls="Calificaciones-menus">
                            <i class="icon">
                        ...
                        <ul class="sub-nav collapse {{ request()->is('dashboard/matriculas*') ||
                        request()->is('dashboard/matricula-aula*') ||
                        Route::is('app.showaula*')
                            ? 'show'
                            : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="{{ request()->is('dashboard/matriculas') ? 'nav-link active' : 'nav-link' }}"
                                    href="{{ url('dashboard/matriculas') }}">
                                    <i class="icon">
                            ...
                            @forelse($menus as $menu)
                                <li class="nav-item">
                                    <a class="{{ request()->routeIs('app.showaula') && request()->route('id') == $menu->id ? 'nav-link active' : 'nav-link' }}"
                                        href="{{ route('app.showaula', $menu->id) }}">
                                        <i class="icon">
                ...
                @if (auth()->user()->hasPermission('VER CONCEPTO'))
                    ...
                    <li class="nav-item">
                        ...
                        Route::is('app.pensionaula*')
                            ? 'active'
                            : '' }}"
                            data-bs-toggle="collapse" href="#pension" role="button" aria-expanded="false"
                            aria-controls="Calificaciones-menus">
                            <i class="icon">
                                <svg class="icon-32" width="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="item-name">Pensión</span>
                            <i class="right-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <ul class="sub-nav collapse {{ request()->is('dashboard/pension*') ||
                        request()->is('dashboard/pension-aula*') ||
                        Route::is('app.pensionaula*')
                            ? 'show'
                            : '' }}"
                            ...
                            @forelse($menus as $menu)
                                <li class="nav-item">
                                    <a class="{{ request()->routeIs('app.pensionaula') && request()->route('id') == $menu->id ? 'nav-link active' : 'nav-link' }}"
                                        href="{{ route('app.pensionaula', $menu->id) }}">
                                        <i class="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="10"
                                                viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                ...
                @if (auth()->user()->hasPermission('VER ASISTENCIA'))
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('dashboard/asistencia-estudiantes*') ||
                        request()->is('dashboard/asistencia-aula*') ||
                        request()->is('dashboard/listar-falta*') ||
                        request()->is('dashboard/asistencia-docentes*')
                            ? 'active'
                            : '' }}"
                            data-bs-toggle="collapse" href="#Calificaciones-menu" role="button"
                            aria-expanded="false" aria-controls="Calificaciones-menu">
                            <i class="icon">
                        ...
                        <ul class="sub-nav collapse {{ request()->is('dashboard/asistencia-estudiantes*') ||
                        request()->is('dashboard/asistencia-aula*') ||
                        request()->is('dashboard/listar-falta*') ||
                        request()->is('dashboard/asistencia-docentes*')
                            ? 'active'
                            ...
                            <li class="nav-item">
                                <a class="{{ request()->is('dashboard/asistencia-estudiantes') ? 'nav-link active' : 'nav-link' }}"
                                    href="{{ url('dashboard/asistencia-estudiantes') }}">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                                    ...
                                    <i class="sidenav-mini-icon">AE</i>
                                    <span class="item-sub-name">Asistencia Estudiante</span>
                                </a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="Administracion" data-bs-parent="#sidebar-menu">
                        ...
                        @if (auth()->user()->hasPermission('VER AÑO LECTIVO'))
                            <li class="nav-item">
                                <a class="{{ request()->is('dashboard/administracion-anolectivo') ? 'nav-link active' : 'nav-link' }}"
                                    href="{{ url('dashboard/administracion-anolectivo') }}">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                        ...
                        @endif
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('dashboard/calendario-escolar') ? 'nav-link active' : 'nav-link' }}"
                                href="{{ url('dashboard/calendario-escolar') }}">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                        fill="currentColor">
                                        <g>
                        ...
                        @if (auth()->user()->hasPermission('VER AULAS'))
                            <li class="nav-item">
                                <a class="{{ request()->is('dashboard/administracion-aulas') ? 'nav-link active' : 'nav-link' }}"
                                    href="{{ url('dashboard/administracion-aulas') }}">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                        ...
                        @if (auth()->user()->hasPermission('VER USUARIOS'))
                            <li class="nav-item">
                                <a class="{{ request()->is('dashboard/administradores') ? 'nav-link active' : 'nav-link' }}"
                                    href="{{ url('dashboard/administradores') }}">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                        ...
                        @if (auth()->user()->hasPermission('VER ROL & PERMISOS'))
                            <li class="nav-item">
                                <a class="{{ request()->is('dashboard/roles-permission') ? 'nav-link active' : 'nav-link' }}"
                                    href="{{ url('dashboard/roles-permission') }}">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
