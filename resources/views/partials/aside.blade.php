            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="{{ request()->is('dashboard/matriculas') ? 'nav-link active' : 'nav-link' }}"
                        aria-current="page" href="{{ url('dashboard/matriculas') }}">
                        <i class="icon">
