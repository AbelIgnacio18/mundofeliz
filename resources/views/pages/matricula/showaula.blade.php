...
<div class="card-header d-flex justify-content-between flex-wrap">
    ...
    <div class="header-title">
        <h3 class="text-primary card-title mb-0">Matricula {{$aula->nivel}} {{$aula->grado}}</h3>
    </div>
            ...
            <tr>
               ...
               <td>
                  <div class="flex align-items-center list-user-action">
                       <a class="btn btn-sm btn-icon text-success" data-bs-original-title="Ver" href="{{route('app.matriculas.show',$matri->id)}}">
