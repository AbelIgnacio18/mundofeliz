<div class="modal fade" id="model-delete-{{$matri->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
      ...
      <div class="modal-content">
         <div class="modal-header">
            ...
            <div class="modal-body text-center mb-3 mt-3">
               <form action="{{ route('app.matriculas.destroy', $matri->id) }}" method="POST">
                  @method('DELETE')
                  @csrf
