...
@section('content')
    <div class="card-header d-flex justify-content-between flex-wrap">
        ...
        <div class="">
            ...
            <a href="{{ route('app.matriculas.exportar') }}"
            ...
            @include('pages.matricula.create')
            ...
            <table id="user-list-table" class="table" role="grid" data-toggle="grid">
                ...
                <tbody>
                    ...
                    @forelse($matricula as $matri)
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">{{ $numeracion }}
                                </div>
                            </td>
                            <td>
    ...
    <script>
        ...
        const urlRFID = "{{ route('app.leer-rfid') }}";
        ...
        setInterval(async () => {
            const res = await fetch(urlRFID);
            const data = await res.json();

            if (data.codigo && data.codigo !== ultimoCodigo && matriculaActual) {
                document.getElementById('codigo-' + matriculaActual).value = data.codigo;
