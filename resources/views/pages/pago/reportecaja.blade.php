...
<body>
    ...
    <div class="control-bar">
        <div class="container">
            <div class="row">
                <div class="col-1">
                    <div class="slogan text-center">Reporte de Pago
                    </div>
                </div>
            </div><!--.row-->
        </div><!--.container-->
    ...
    <div class="container">
        ...
        <div class="me">
            <h3>
                ...
                DINERO EFECTIVO:s/{{$totales->total_efectivo}}<br>
                DINERO DIGITAL:s/{{$totales->total_digital}}<br>
                MONTO TOTAL:s/ {{$totales->total_monto}}
            </h3>
        </div><!--.me-->
