...
<div class="card-header d-flex justify-content-between flex-wrap">
   ...
   <div class="header-title">
      <h4 class="card-title mb-0">Lista de Concepto de Pagos</h4>
   </div>
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title" id="staticBackdropLabel">Nuevo Concepto de Pagos</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
               </div>
               <div class="modal-body">
                  <form action="{{ route('app.concepto-pago.store') }}" method="POST">
                     @method('POST')
                     @csrf
                     ...
                     <div class="form-group">
                        <label for="conceptoS" class="form-label">Nombre de Concepto de Pago:</label>
                        <input type="text" class="form-control" id="conceptoS" aria-describedby="conceptoS" placeholder="Pensión" name="concepto">
                     </div>
                     <div class="form-group">
...
<!--                <td>
               ...
               <td>
                  <div class="flex align-items-center list-user-action">
                     ...
                     @if($concep->id!=1)
                     <a class="btn btn-sm btn-icon text-danger" data-bs-toggle="modal" data-bs-original-title="Eliminar" data-bs-target="#model-delete-{{$concep->id}}">
                        <span class="btn-inner">
            ...
            @include('pages.concepto.modal')
            @include('pages.concepto.edit')
