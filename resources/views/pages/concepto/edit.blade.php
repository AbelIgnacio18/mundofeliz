   ...
   <div class="modal-dialog">
      <div class="modal-content">
            ...
            <div class="modal-body">
               <form action="{{ route('app.concepto-pago.update', $concep->id) }}" method="POST">
                  @method('PUT')
                  @csrf
                  ...
                  <div class="form-group">
                        ...
                        <input type="text" name="codigo" class="form-control" id="codigo"
                           aria-describedby="codigo" placeholder="codigo" value="{{ $concep->codigo }}">
                  </div>
                  ...
                  <div class="form-group">
                        ...
                        <input type="concepto" name="concepto" class="form-control" id="concepto"
                           aria-describedby="concepto" value="{{ $concep->concepto }}">
                  </div>
                  <div class="form-group">
                        ...
                        <div class="input-group col-md-12">
                           ...
                           <input type="number" class="form-control" id="monto" aria-describedby="monto"
                              placeholder="Nombre de concepto" name="monto" value="{{number_format($concep->monto)}}">
                        </div>
                  </div>
