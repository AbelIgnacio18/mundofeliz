...
<div class="card-header d-flex justify-content-between flex-wrap">
   ...
   <div class="header-title">
      <h4 class="card-title mb-0">Lista de Pensiones</h4>
   </div>
         ...
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <form action="{{ route('app.pension.store') }}" method="POST">
                     @method('POST')
                     @csrf
...
@include('pages.pension.pdfasistencia')
@include('pages.pension.search')
   ...
   <div class="table-responsive mt-4">
      <table id="user-list-table" class="table table-striped" role="grid" data-toggle="grid">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <div class="flex align-items-center list-user-action">
                     ...
                     <a class="btn btn-sm btn-icon text-success" data-bs-original-title="Ver" href="{{route('app.pension.show',$matri->id)}}">
            ...
            @include('pages.pension.delete')
            @include('pages.pension.edit')
