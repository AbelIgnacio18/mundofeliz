                        ...
                        <div class="modal-body raw">
                            <form action="{{ route('app.estudiantes.store') }}" method="POST">
                                ...
                                <div class="raw d-flex">
                                    ...
                                    <div class="form-group col-md-4 p-1">
                                        ...
                                        <input type="text" class="form-control" id="apellidop"
                                            aria-describedby="apellidop" placeholder="Silva" name="apellidop"
                                            value="{{ old('apellidop') }}">
                                    </div>
                                    ...
                                    <div class="form-group col-md-4  p-1">
                                        ...
                                        <input type="text" class="form-control" id="apellidom"
                                            aria-describedby="apellidom" placeholder="Fernández" name="apellidom"
                                            value="{{ old('apellidom') }}">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="apellidom"
                                        aria-describedby="apellidom" placeholder="Jr. Tacna N°358" name="direccion"
                                        value="{{ old('direccion') }}">
                                </div>
