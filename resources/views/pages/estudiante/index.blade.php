...
<div class="card-header d-flex justify-content-between flex-wrap" style="margin-bottom: 1.5rem;">
    ...
    <div class="">
        ...
        <a href="#" class=" text-center btn btn-success btn-icon mt-lg-0 mt-md-0 mt-3" data-bs-toggle="modal"
            data-bs-target="#model-import">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
        ...
        <a href="{{ route('app.estudiantes.plantilla') }}"
            class="text-center btn btn-success btn-icon mt-lg-0 mt-md-0 mt-3">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                class="bi bi-filetype-xlsx" viewBox="0 0 16 16">
                <path fill-rule="evenodd"
                    d="M14 4.5V11h-1V4.5h-2A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v9H2V2a2 2 0 0 1 2-2h5.5zM7.86 14.841a1.13 1.13 0 0 0 .401.823q.195.162.479.252.284.091.665.091.507 0 .858-.158.355-.158.54-.44a1.17 1.17 0 0 0 .187-.656q0-.336-.135-.56a1 1 0 0 0-.375-.357 2 2 0 0 0-.565-.21l-.621-.144a1 1 0 0 1-.405-.176.37.37 0 0 1-.143-.299q0-.234.184-.384.188-.152.513-.152.214 0 .37.068a.6.6 0 0 1 .245.181.56.56 0 0 1 .12.258h.75a1.1 1.1 0 0 0-.199-.566 1.2 1.2 0 0 0-.5-.41 1.8 1.8 0 0 0-.78-.152q-.44 0-.777.15-.336.149-.527.421-.19.273-.19.639 0 .302.123.524t.351.367q.229.143.54.213l.618.144q.31.073.462.193a.39.39 0 0 1 .153.326.5.5 0 0 1-.085.29.56.56 0 0 1-.255.193q-.168.07-.413.07-.176 0-.32-.04a.8.8 0 0 1-.249-.115.58.58 0 0 1-.255-.384zm-3.726-2.909h.893l-1.274 2.007 1.254 1.992h-.908l-.85-1.415h-.035l-.853 1.415H1.5l1.24-2.016-1.228-1.983h.931l.832 1.438h.036zm1.923 3.325h1.697v.674H5.266v-3.999h.791zm7.636-3.325h.893l-1.274 2.007 1.254 1.992h-.908l-.85-1.415h-.035l-.853 1.415h-.861l1.24-2.016-1.228-1.983h.931l.832 1.438h.036z" />
                        ...
                        <form action="{{ route('app.estudiantes.store') }}" method="POST">
                            ...
                            <div class="raw d-flex">
                                <div class="form-group col-md-6 p-1">
                                    <label for="dni" class="form-label">DNI: <span class="badge bg-danger">Obligatorio</span></label>
                                ...
                                <div class="form-group col-md-6 p-1">
                                    ...
                                    <input type="text" class="form-control" id="nombre" aria-describedby="nombre"
                                        placeholder="ANDREA" name="nombre" value="{{ old('nombre') }}">
                                </div>
                            </div>
                            <div class="raw d-flex">
                                <div class="form-group col-md-6 p-1">
                                    ...
                                    <input type="text" class="form-control" id="apellidop"
                                        aria-describedby="apellidop" placeholder="FLORES" name="apellidop"
                                        value="{{ old('apellidop') }}">
                                </div>
                                ...
                                <div class="form-group col-md-6 p-1">
                                    ...
                                    <input type="text" class="form-control" id="apellidom"
                                        aria-describedby="apellidom" placeholder="GONZALES" name="apellidom"
                                        value="{{ old('apellidom') }}">
                                </div>
                            </div>
                            ...
                            <div class="raw d-flex">
                                ...
                                <label for=" apellidom" class="form-label">Dirección:</label>
                                    <input type="text" class="form-control" id="apellidom"
                                        aria-describedby="apellidom" placeholder="Calle Real N°859 - Chilca, Huancayo" name="direccion"
                                        value="{{ old('direccion') }}">
                                </div>
                                ...
                                <label for=" apellidom" class="form-label">Observaciones:</label>
                                    <input type="text" class="form-control" id="apellidom"
                                        aria-describedby="apellidom" name="observaciones"
                                        value="{{ old('apellidom') }}">
                                </div>
                            </div>
                            ...
                            <div class="raw d-flex">
                                <div class="form-group col-md-6 p-1">
                                    <label for="Codigo" class="form-label">DNI del Apoderado: <span class="badge bg-danger">Obligatorio</span></label>
                                    <input type="text" class="form-control" id="dniapoderado" aria-describedby="Codigo"
                                        placeholder="87654321" name="dniapoderado" value="{{ old('dniapoderado') }}">
                                </div>

                                <div class="form-group col-md-6 p-1">
                                    <label for="apellidom" class="form-label">Nombre del Apoderado:</label>
                                    <input type="text" class="form-control" id="" aria-describedby=""
                                        placeholder="Nombre Completo" name="nombreapoderado"
                                        value="{{ old('apellidom') }}">
                                </div>
                            </div>
