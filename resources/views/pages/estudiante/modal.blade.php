<div class="modal fade" id="model-delete-{{ $estud->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
   ...
   <div class="modal-dialog">
      <div class="modal-content">
            ...
            <div class="modal-body text-center mb-3 mt-3">
               <form action="{{ route('app.estudiantes.destroy', $estud->id) }}" method="POST">
                  @method('DELETE')
                  @csrf
