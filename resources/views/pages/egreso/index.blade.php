   ...
   <div class="table-responsive mt-4">
      <table class="table table-striped" role="grid" data-toggle="data-table">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <div style="float:center">
                     ...
                     <a class="btn btn-sm btn-icon text-success" data-bs-original-title="Ver" href="{{route('app.admin-egresos.show',$pag->id)}}">
            ...
            @include('pages.egreso.modal')
            @include('pages.egreso.edit')
