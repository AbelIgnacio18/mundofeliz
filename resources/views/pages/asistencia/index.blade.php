...
<div class="card-header d-flex justify-content-between flex-wrap">
   ...
   <div class="">
      ...
      <a class="btn btn-danger btn-round ml-auto" type="button" target="_blank" href="{{ route('app.reporteasistenciadocente') }}">
...
<th>Estado</th>
 ...
 <a class="btn btn-sm btn-icon text-success" data-bs-original-title="Ver" href="{{route('app.asistencia.show',$item->id)}}">
                        <span class="btn-inner">
