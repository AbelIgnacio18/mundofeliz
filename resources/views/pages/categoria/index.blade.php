...
@section('tab_tittle','Lista de catgoria ')
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <form action="{{ route('app.categoria.store') }}" method="POST">
                     @method('POST')
                     @csrf
            ...
            <tr>
               ...
               <td>
                  <div class="flex align-items-center list-user-action">
                     <a class="btn btn-sm btn-icon text-warning" data-bs-toggle="modal" data-bs-original-title="Editar" data-bs-target="#model-edit-{{$cat->id}}">
                     ...
                     @if($cat->id!=1)
                     <a class="btn btn-sm btn-icon text-danger" data-bs-toggle="modal" data-bs-original-title="Eliminar" data-bs-target="#model-delete-{{$cat->id}}">
                        <span class="btn-inner">
