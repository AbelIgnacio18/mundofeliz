...
@section('tab_tittle', 'Configuraciones del sistema')
...
<div class="card-header d-flex justify-content-between flex-wrap">
   ...
   <div class="header-title">
      <h4 class="card-title mb-0">Lista de Ciclo Lectivo</h4>
   </div>

   <!-- modal para crear nuevos itemtos de pagooo -->
   <div class="">
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <form action="{{ route('app.config-lectivo.store') }}" method="POST">
                     @method('POST')
                     @csrf
                     ...
                     <div class="form-group">
                        <label for="inicio" class="form-label">Inicio del Período:</label>
                      <input type="date" class="form-control" id="nivelS" aria-describedby="nivelS" name="inicio" step="1">
                     </div>

                     <div class="form-group">
                        <label for="fin" class="form-label">Final del Período:</label>
                  <input type="date" class="form-control" id="nivelS" aria-describedby="nivelS" name="fin" step="1">
                     </div>
   ...
   <div class="table-responsive mt-4 col-12">
      <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
         ...
         <tbody>
            ...
            @include('pages.anolectivo.modal')
            @include('pages.anolectivo.edit')
