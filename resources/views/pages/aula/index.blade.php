               ...
               <div class="modal-body">
                  <form action="{{ route('app.config-aulas.store') }}" method="POST">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="seccionS" aria-describedby="seccionS" placeholder="A" name="seccion">
                     </div>


                     <div class="form-group">
                        <label for="tiempo general" class="form-label">Hora de Entrada</label>
                        <input type="time" class="form-control" id="tiempo" name="tiempo" value="08:00:60"  step="01" required="">
      ...
      <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <h6>
                      {{Carbon\Carbon::parse($item->tarde)->translatedFormat('h:i A')}}
                  </h6>
               </td>
               <td>
                  <h6>{{$item->vacantes}}</h6>
