...
@section('content')
    <div class="card-header d-flex justify-content-between flex-wrap">
        ...
        <div class="">
            ...
            @include('pages.administrativo.import')
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body raw">
                            <form action="{{ route('app.personal.store') }}" method="POST">
                                @method('POST')
                                @csrf
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" aria-describedby="dni" placeholder="87654321"
                                        name="dni" id="dni_docente" value="{{ old('dni') }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="apellidop" aria-describedby="apellidos"
                                        placeholder="Silva" name="apellidos" value="{{ old('apellidos') }}">
                                </div>
                                <div class="form-group">
            ...
            <table class="table table-striped" role="grid" data-toggle="data-table">
                ...
                <tbody>
                    @forelse($items as $estud)
                        ...
                        @include('pages.administrativo.modal')
                        @include('pages.administrativo.edit')
            ...
            if (dni.length === 8) {
                ...
                try {
                    ...
                    if (data.success) {
                        ...
                        document.getElementsByName('apellidos')[0].value = data.apellidoPaterno + ' ' + data
                            .apellidoMaterno;;
