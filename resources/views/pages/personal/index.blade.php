...
<div class="card-header d-flex justify-content-between flex-wrap">
   ...
   <div class="header-title">
      <h4 class="card-title mb-0">Lista del Personal Academico</h4>
   ...
   <div class="">
      ...
      <div id="alerts-disimissible-component" class="tab-pane tab-example-result fade active show col-md-12" role="tabpanel" aria-labelledby="alerts-disimissible-component-tab">
   ...
   <div class="table-responsive mt-4">
      <table class="table table-striped" role="grid" data-toggle="data-table">
         ...
         <tbody>
            ...
            @include('pages.personal.modal')
            @include('pages.personal.edit')
