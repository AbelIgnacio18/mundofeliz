<div class="modal fade" id="staticBackdrop-1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="reportepdf" aria-hidden="true">
     <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
              <h5 class="modal-title" id="reportepdf">Registrar sin Tarjeta</h5>
              ...
              <form action="{{ route('app.asist-estudiante.store') }}" method="POST">
                 ...
                 <div class="form-group">
                    ...
                    <select name="matricula_id[]" class="form-control" required id="ex-search" multiple>
                       ...
                       <option value="{{$ma->id}}"> {{$ma->estudiante->nombre}} {{$ma->estudiante->apellidos}} - {{$ma->estudiante->dni}}</option>
