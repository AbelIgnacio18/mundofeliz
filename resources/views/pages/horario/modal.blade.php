<div class="modal fade" id="model-delete-{{ $docenteId }}" data-bs-backdrop="static" data-bs-keyboard="false"
      ...
      <div class="modal-content">
         <div class="modal-header">
            ...
            <div class="modal-body text-center mb-3 mt-3">
               <form action="{{ route('app.docenteshorarios.destroy', $docenteId) }}" method="POST">
                  @method('DELETE')
                  @csrf
