<div class="modal fade" id="model-edit-{{$usu->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('app.administradores.update',$usu->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" aria-describedby="nombre" placeholder="Nombre" name="name" value="{{$usu->name}}">
                    </div>

                    <div class="form-group">
                        <label for="Apellidos" class="form-label">Apellidos:</label>
                        <input type="text" class="form-control" id="Apellidos" aria-describedby="Apellidos" placeholder="Apellidos" name="apellidos" value="{{$usu->apellidos}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                          <label for="modulo" class="form-label">Estado:</label>
                           ...
                           <div class="form-check">
                              <input class="form-check-input" type="radio" name="estado" id="efetivo" value="0" style="cursor:pointer" @if($usu->estado==0) checked @endif>
                              <label class="form-check-label" for="efetivo">
                                 Deshabilitado
                              </label>
                           </div>
