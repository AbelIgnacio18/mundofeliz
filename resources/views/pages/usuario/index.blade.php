...
@section('tab_tittle','Lista de usuarios')
               ...
               <div class="modal-body">
                  <form action="{{ route('app.administradores.store') }}" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" aria-describedby="nombre" placeholder="Nombre" name="name" value="{{old('name')}}">
                     </div>

                     <div class="form-group">
                        <label for="Apellidos" class="form-label">Apellidos:</label>
                        <input type="text" class="form-control" id="Apellidos" aria-describedby="Apellidos" placeholder="Apellidos" name="apellidos" value="{{old('apellidos')}}">
                     </div>
                     <div class="form-group">
      ...
      <table id="basic-table" class="table table-striped mb-0" role="grid">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <div class="icon iq-icon-box-3 rounded-pill">{{$usu->name}} {{$usu->apellidos}}</div>
               </td>
               ...
               <td>
                  <div style="float:center;">
                     <a class="btn btn-sm btn-icon text-warning" data-bs-toggle="modal" data-bs-original-title="Editar" data-bs-target="#model-edit-{{$usu->id}}">
                     ...
                     <a class="btn btn-sm btn-icon text-danger " data-bs-toggle="modal" data-bs-original-title="Eliminar" data-bs-target="#model-delete-{{$usu->id}}">
                        <span class="btn-inner">
