...
@section('content')
    <div class="card-header d-flex justify-content-between flex-wrap">
        ...
        <div class="">
            @if (Auth::user()->roles[0]->nombre == 'SuperAdmin')
                ...
                <tbody>
                    ...
                    @forelse($usuario as $usu)
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="icon iq-icon-box-3 rounded-pill">{{ $usu->name }} {{ $usu->apellidos }}
                                    </div>
                                </td>
                                ...
                                <td>
                                    @forelse($usu->sedes as $sede)
                                        <span class="badge bg-info">{{ $sede->nombre }}</span>
                                    @empty
                                    @endforelse
                                </td>
                                ...
                                <td>
                                    @if ($usu->foto != '')
                                        <img class="bg-soft-primary rounded img-fluid avatar-40 me-3"
                                            src="{{ asset('imagenes/avatar/' . $usu->foto) }}" alt="{{ $usu->id }}"
                                ...
                                <td>
                                    <div style="float:center;">
                                        <a class="btn btn-sm btn-icon text-warning" data-bs-toggle="modal"
                                            ...
                                            data-bs-target="#model-edit-{{ $usu->id }}">
                                        ...
                                        <a class="btn btn-sm btn-icon text-danger " data-bs-toggle="modal"
                                            ...
                                            data-bs-target="#model-delete-{{ $usu->id }}">
                                            <span class="btn-inner">
                                                <svg width="20" viewBox="0 0 24 24" fill="none"
