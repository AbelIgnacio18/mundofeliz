...
var newRow = '<tr><td><a class="control removeRow" href="#">x</a><span contenteditable>P001</span></td><td><span contenteditable>Pensión</span></td><td class="amount"><input type="text" value="1"/></td><td class="rate"><input type="text" value="250" /></td><td class="tax taxrelated"></td><td class="sum"></td></tr>';
