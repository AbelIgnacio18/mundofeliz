...
class PensionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request) {
         ...
         'estudiante.pagos.pensiones.concepto'
            ...
            $aula = Aula::get();
            return view('pages.pension.index', compact('estudiante', 'aula', 'matricula', 'concepto','searchText'));
        }
    }
     ...
     public function show($id)
    {
        ...
        //  dd($matricula);
        return view("pages.pension.show", compact('matricula', 'mes', 'avancepen', 'otros', 'articulo'));
    }
    ...
    public function showaula($id)
    {
        ...
        //  dd($matricula);
        return view("pages.pension.showaula", compact('matricula','aula'));
    }
